<?php
	...
	class ModeloServicios{
		...
		static public function mdlCrearServicio($tabla, $datos){
			...
			$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(fecha_servicio, id_netbook, reclamo, problema, solucion) VALUES (:fecha_servicio, :id_netbook, :reclamo, :problema, :solucion)");

			
			$stmt->bindParam(":fecha_servicio", $datos["fecha_servicio"], PDO::PARAM_STR);
			$stmt->bindParam(":id_netbook", $datos["id_netbook"], PDO::PARAM_INT);
			$stmt->bindParam(":reclamo", $datos["reclamo"], PDO::PARAM_STR);
		...
		static public function mdlEditarServicio($tabla, $datos){
			...
			$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET reclamo = :reclamo, problema = :problema, solucion = :solucion WHERE id_servicio = :id_servicio");
