        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=9 idCurso2=10 tabla="tercero" data-toggle="modal" data-target="#modalCopiaSaberes">
                  
                  Copia Saberes
                </button>

                <button class="btn btn-primary btnInformeArea" area="antropologia3" periodo="'.$_SESSION['periodo'].'" idCurso=9 idCurso2=10 idCurso3=0 idCurso4=0 modalidad="Ciencias Sociales y Humanidades" tabla="tercero" informe="informe-area-orientacion">
