...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Informe de Seguimiento Bloque Académico - 2º Año TM - Educación Física
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Informe de Seguimiento Bloque Académico - 2º Año TM - Educación Física</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnSeguimientoArea" area="fisica" idCurso=3 tabla="seguimiento" periodo="'.$_SESSION['periodo'].'" informe="seguimiento-area">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarSeguimientoFisica" nombreAlumno="'.$value["nombre"].'" tabla="seguimiento" periodo="'.$_SESSION['periodo'].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarSeguimiento"><i class="fa fa-pencil"></i></button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" id="modalInforme">
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <label for="acreditacionFisica">Criterio de Acreditación</label>
                      <textarea class="form-control" cols="80" rows="4" id="acreditacionFisica" name="acreditacionFisica">
                  </textarea>
              </div>
                ...
                <label for="evaluacionFisica">Criterio de Evaluación</label>
                    <textarea class="form-control" cols="80" rows="4" id="evaluacionFisica" name="evaluacionFisica">
                </textarea>
            </div>
                ...
                <label for="indicadorFisica">Indicador de Evaluación</label>
                    <textarea class="form-control" cols="80" rows="4" id="indicadorFisica" name="indicadorFisica">
                </textarea>
            </div>
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
              ...
              <div class="form-group">          
                  <label for="observaFisica">Comentarios y Sugerencias para la Continuidad de la Trayectoria</label>
                      <textarea class="form-control" cols="80" rows="4" id="observaFisica" name="observaFisica">
                  </textarea>
              </div>
         ...
         <?php
              ...
              $tabla = "seguimiento";
              $curso = "2tm-seguimiento-fisica";

              $editarInforme = new ControladorInformes();
              $editarInforme -> ctrEditarSeguimientoFisica($tabla, $curso);
