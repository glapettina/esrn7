              ...
              <?php
                  ...
                  foreach ($cursos as $key => $value) {
                    ...
                    echo '<tr>
                          ...
                          echo '<td><button class="btn btn-success btn-xs btnActivarCurso" idCurso="'.$value["id"].'" estadoCurso="0">Activado</button></td>';

                        }else{

                          echo '<td><button class="btn btn-danger btn-xs btnActivarCurso" idCurso="'.$value["id"].'" estadoCurso="1">Desactivado</button></td>';
                        }
