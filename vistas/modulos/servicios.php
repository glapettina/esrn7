              ...
              <?php
                  ...
                  foreach ($servicios as $key => $value) {
                    ...
                    echo '<tr>
                          ...
                          $fecha_real = date("d-m-Y",strtotime($value["fecha_servicio"]));
                          ...
                          if ($value["estado"] != 0) {
                            ...
                            echo '<td><button class="btn btn-success btn-xs btnActivarServicio" idServicio="'.$value["id_servicio"].'" estadoServicio="0">Resuelto</button></td>';

                        }else{

                            echo '<td><button class="btn btn-danger btn-xs btnActivarServicio" idServicio="'.$value["id_servicio"].'" estadoServicio="1">Pendiente</button></td>';
                        }
      ...
      <form role="form" method="post">
          ...
          <div class="modal-body">
            ...
            <div class="box-body">
              ...
              <!-- ENTRADA PARA EL NUMERO DE RECLAMO -->          
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control input-lg" type="text" id="nuevoReclamo" name="nuevoReclamo" placeholder="Ingresar Nº Reclamo">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-addon"><i class="fa fa-th"></i></span>
                  <input class="form-control input-lg" type="text" id="editarReclamo" name="editarReclamo" >
