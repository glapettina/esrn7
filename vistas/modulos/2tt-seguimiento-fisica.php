...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Informe de Seguimiento Bloque Académico - 2º Año TT - Educación Física
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Informe de Seguimiento Bloque Académico - 2º Año TT - Educación Física</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnSeguimientoArea" area="fisica" idCurso=4 tabla="seguimiento" periodo="'.$_SESSION['periodo'].'" informe="seguimiento-area">
