        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnInformeArea" area="comunicacion" periodo="'.$_SESSION['periodo'].'" idCurso=13 idCurso2=14 idCurso3=0 idCurso4=0 modalidad="Ciencias Sociales y Humanidades" tabla="cuarto" informe="informe-area-orientacion">
