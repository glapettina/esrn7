                    ...
                    echo '<tr>
                          ...
                          echo '<td>
                            ...
                            if ($_SESSION["perfil"] != "Preceptor") {
                              ...
                              echo'<button class="btn btn-primary btnImprimirSeguimiento" informe="seguimiento" periodo="'.$_SESSION['periodo'].'" tabla="seguimiento" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>
