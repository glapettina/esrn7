              ...
              <?php
                  ...
                  foreach ($ciudades as $key => $value) {
                    ...
                    echo '<tr>
                          ...
                          echo '<td><button class="btn btn-success btn-xs btnActivarCiudad" idCiudad="'.$value["id_ciudad"].'" estadoCiudad="0">Activado</button></td>';

                        }else{

                          echo '<td><button class="btn btn-danger btn-xs btnActivarCiudad" idCiudad="'.$value["id_ciudad"].'" estadoCiudad="1">Desactivado</button></td>';
                        }
