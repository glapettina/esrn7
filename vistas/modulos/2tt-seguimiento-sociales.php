        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button class="btn btn-primary btnSeguimientoArea" area="sociales" idCurso=4 tabla="seguimiento" periodo="'.$_SESSION['periodo'].'" informe="seguimiento-area">
      ...
      <form role="form" method="post" id="modalInforme">
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
         ...
         <?php
              ...
              $tabla = "seguimiento";
              $curso = "2tt-seguimiento-sociales";
